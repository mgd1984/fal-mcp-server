...
> **Note**: GitHub blocks custom protocol links for security. Copy the link below and paste it into your browser's address bar.

**Install Recipe**:
```
goose://recipe?config=%3D
```
...
### Using Goose CLI
```bash
goose session start --recipe "FAL.ai Patch Generator"
```
...
### Manual Setup
Follow the installation instructions below for a manual setup.
